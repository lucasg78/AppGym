...
def vista_plantilla(request):
    # Abrimos el archivo
    archivo = open(r"G:\Mi unidad\Formación\Programación\Python\Práctica\AppGym\AppGym\AppGym\templates\inicio.html")
...
def vista_listado_alumnos(request):
    # Abrimos el archivo
    archivo = open(r"G:\Mi unidad\Formación\Programación\Python\Práctica\AppGym\AppGym\AppGym\templates\listado_alumnos.html")
...
def vista_listado_clases(request):
    # Creamos el diccionario de datos para la plantilla
    listado_alumnos = ["Juana", "Pablo", "Hernán", "Raquel"]
    datos = {"clase":"Funcional", "listado_alumnos": listado_alumnos}

    # Creamos el template
    plantilla = loader.get_template("listado_clases.html")
